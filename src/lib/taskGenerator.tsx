...
export const generateTasksForRenter = (movingInfo: MovingInfo, householdInfo?: HouseholdInfo): Task[] => {
  ...
  tasks.push(
    ...
    {
      id: "rent-phase1-5a",
      title: "Vergelijk energieleveranciers",
      category: "Nutsvoorzieningen",
      description: "Vergelijk prijzen en voorwaarden van verschillende energieleveranciers.",
      deadline: adjustDeadline(addDays(movingDate, -35), 'normal'),
      deadlineLabel: "Binnenkort",
      phase: "Fase 1 - Je nieuwe thuis is bevestigd",
      status: "todo",
    ...
    {
      id: "rent-phase1-5b",
      title: "Kies energieleverancier",
      category: "Nutsvoorzieningen",
      description: "Sluit een contract af bij de energieleverancier van je keuze.",
