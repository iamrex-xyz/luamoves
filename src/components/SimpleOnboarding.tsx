  ...
  if (step === 1) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary-light via-primary-light/80 to-white overflow-y-auto">
        ...
        {/* Floating WhatsApp CTA Button — small circular FAB */}
        <a
          href={CHAT_CTA_URL}
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full shadow-xl shadow-green-500/30 bg-[#25D366] hover:bg-[#20bd5a] text-white flex items-center justify-center transition-colors"
          aria-label={CHAT_CTA_LABEL}
        >
