...
export const SignupPromptDialog = ({
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent 
        className="sm:max-w-lg max-h-[90vh] overflow-y-auto animate-in fade-in-0 zoom-in-95 duration-200"
      ...
      >
        <DialogHeader className="text-center space-y-2">
          ...
          <DialogDescription className="text-base text-muted-foreground">
            Maak je account compleet — dan kunnen wij jouw verhuizing slim organiseren en alles voor je bijhouden.
          </DialogDescription>
        </DialogHeader>
